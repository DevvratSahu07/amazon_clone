                ...
                <div className="card-body">
                    ...
                    <form className="needs-validation" onSubmit={props.handleSubmit} autoComplete="off"  noValidate>
                        <div className="form-group">
                            ...
                            <input type="text" name="name" className="form-control" placeholder="abc" id="userName" value={props.name} onChange={props.handleChange} required minLength="3" />
                        ...
                        <div className="form-group">
                            ...
                            <div className="invalid-feedback">
                                <i className="fas text-danger fa-exclamation-triangle"></i> Some error in ema il.
                            </div>
                        </div>
                        <div className="form-group">
